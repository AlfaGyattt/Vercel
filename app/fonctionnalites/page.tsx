          ...
          <div className="w-full max-w-7xl mx-auto px-6 md:px-16 py-24">
            ...
            >
              ...
              <div className="flex gap-4 flex-wrap mt-2">
                <Link href="/" className="flex items-center gap-2.5 px-7 py-3.5 rounded-full font-roboto font-700 text-sm text-black bg-white hover:bg-white/90 active:scale-[0.97] transition-all">
                  <Apple size={16} /> App Store
                </Link>
                <Link href="/" className="flex items-center gap-2.5 px-7 py-3.5 rounded-full font-roboto font-700 text-sm text-white border border-white/25 hover:border-white/50 active:scale-[0.97] transition-all">
