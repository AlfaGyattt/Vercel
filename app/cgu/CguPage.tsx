      ...
      <main className="min-h-screen bg-[#080010] pt-32 pb-20 px-6 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-8 font-roboto text-white/60 leading-relaxed" style={{ fontSize: "15px" }}>
          ...
          <section>
            ...
            <p>Les présentes conditions générales d'utilisation régissent l'accès et l'utilisation du site mood2fit.app édité par Mood2Fit. En accédant au site, vous acceptez sans réserve les présentes CGU.</p>
          </section>

          <section>
            <h2 className="font-roboto font-700 mb-3 uppercase tracking-widest" style={{ fontSize: "11px", color: "#f72585" }}>Accès au site</h2>
            <p>Le site mood2fit.app est accessible gratuitement à tout utilisateur disposant d'un accès à Internet. Mood2Fit se réserve le droit de modifier, suspendre ou interrompre l'accès au site à tout moment, sans préavis.</p>
          </section>
          ...
          <section>
            ...
            <p>Pour toute question relative aux CGU : <a href="mailto:hello@mood2fit.app" className="text-white hover:text-[#f72585] transition-colors">hello@mood2fit.app</a></p>
          </section>
