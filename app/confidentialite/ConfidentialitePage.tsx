      ...
      <main className="min-h-screen bg-[#080010] pt-32 pb-20 px-6 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col gap-8 font-roboto text-white/60 leading-relaxed" style={{ fontSize: "15px" }}>
          ...
          <section>
            ...
            <p>Mood2Fit accorde une grande importance à la protection de vos données personnelles. Cette politique de confidentialité décrit comment nous collectons, utilisons et protégeons vos informations lorsque vous utilisez notre site mood2fit.app.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">Pour exercer ces droits, contactez-nous à : <a href="mailto:hello@mood2fit.app" className="text-white hover:text-[#f72585] transition-colors">hello@mood2fit.app</a></p>
          </section>
